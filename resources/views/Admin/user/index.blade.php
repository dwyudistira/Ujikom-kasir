    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('admin.user.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md transition flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    html: `<div class="text-center">
                            ...
                            <p class="text-lg font-medium text-gray-800">Anda akan menghapus pengguna:</p>
                            <p class="text-xl font-bold text-red-600 my-2">${userName}</p>
